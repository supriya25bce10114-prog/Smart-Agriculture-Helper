...
Decision-based crop recommendation
...
Basic understanding of Python conditionals
...
The code and documentation are created independently

All references (if any) are properly acknowledged

The project is submitted as per required guidelines
